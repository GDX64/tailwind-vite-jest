<template>
  <div class="w-full flex flex-col items-center">
    <div class="w-full px-4 flex flex-col text-base max-w-lg">
      ...
      <GStage class="w-full aspect-[2/1] border border-black">
        <template #default="{}">
          <GScale :x-data="scaleData.x" :y-data="scaleData.y">
            <template #default="{ scaleXY: { x, y, alphaX } }">
              <PixiSquare
                ...
                :x="x(el - 11)"
                :y="
                  y(10 * Math.sin((time * frequency * 2 * Math.PI) / 1000 + el * phase))
                "
                :height="alphaX"
                :width="alphaX"
                fill="#00ffff"
